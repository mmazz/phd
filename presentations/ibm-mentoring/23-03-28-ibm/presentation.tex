...
\only<2>{
    \begin{figure}
        \includegraphics[width=1.05\textwidth]{architecture0.png}
    \end{figure}
}
\only<3>{
    \begin{figure}
        \includegraphics[width=1.05\textwidth]{architecture1.png}
    \end{figure}
}
\only<4>{
    \begin{figure}
        \includegraphics[width=1.05\textwidth]{architecture2.png}
    \end{figure}
}
\only<5>{
    \begin{figure}
...
\only<6>{
    \begin{figure}
        \includegraphics[width=1.05\textwidth]{architecture4.png}
    \end{figure}
}

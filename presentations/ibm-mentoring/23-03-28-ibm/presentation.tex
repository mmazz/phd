...
\pause
The schemes are iterative, operating many time with each data specialy Bootstrapping.
...
\begin{itemize}\itemsep-0.7em
   ...
   \item Software Optimization. % chequear
   \item Algorithms implementations.
...
\begin{frame}
\frametitle{}
security assumptions + selecting parameters
\end{frame}

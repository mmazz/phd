...
if(len(sys.argv)==1):
    ...
    fileHD = "encodeHD_multiRNS.txt"
    fileHD_RNS = "encodeHD_multiRNS_RNSactive.txt"
    extra = "_multiRNS"
    RNS_size = 5
    total_bits_HDCompare = 2*RNS_size*num_bits*polynomial_size
    num_coeff = int(polynomial_size*RNS_size)
...
if(ejecute):
    ...
    encodingHD = data_read(dir, fileHD, True, int(total_bits_HDCompare*RNS_proportion))
    ...
    if(non_RNS):
        ...
        encodingHD_RNS = data_read(dir, fileHD_RNS, True, int(total_bits_HDCompare*RNS_proportion_ActiveRNS))

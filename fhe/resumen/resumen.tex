...
$\alpha$ son los coeficientes del polinomio codificado.

Para el caso que nos interesa tenemos que hacer algunos pasos extras.
Por un lado necesitamos que los coefficientes del polinomio ahora sean numeros enteros.
Para ello vamos a usar el encaje canonico.

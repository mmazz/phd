...
\begin{equation*}
    Prject_{\beta}(z) = \sum_{i=0}^{N-1}\frac{<z,\beta_i>}{<\beta_i,\beta_i>}\beta_i
    \label{eq:project}
\end{equation*}

En la implementacion de Python, lo que hacen es primero calcular los productos internos Hermitianos,
luego aplicarle el algoritmo de redondeo y luego multiplicar por adelante la matriz
de Vandermonde transpuesta.
